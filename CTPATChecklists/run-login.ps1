...
# === Config ===
$category = 'Login'
$covOut   = "TestResults\CoverageReport\Login"
...
# Descubrir proyectos de prueba en toda la solución
...
foreach ($proj in $projects) {
  ...
  # 2) Fallback sin filtro si no hubo matches
